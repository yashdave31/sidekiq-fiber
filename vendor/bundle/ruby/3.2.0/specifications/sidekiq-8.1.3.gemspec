...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<redis-client>.freeze, [">= 0.26.0"])
  s.add_runtime_dependency(%q<connection_pool>.freeze, [">= 3.0.0"])
  s.add_runtime_dependency(%q<rack>.freeze, [">= 3.2.0"])
  s.add_runtime_dependency(%q<json>.freeze, [">= 2.16.0"])
  s.add_runtime_dependency(%q<logger>.freeze, [">= 1.7.0"])
end

...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<console>.freeze, ["~> 1.29"])
  s.add_runtime_dependency(%q<fiber-annotation>.freeze, [">= 0"])
  s.add_runtime_dependency(%q<io-event>.freeze, ["~> 1.11"])
  s.add_runtime_dependency(%q<metrics>.freeze, ["~> 0.12"])
  s.add_runtime_dependency(%q<traces>.freeze, ["~> 0.18"])
end
